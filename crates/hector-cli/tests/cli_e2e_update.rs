//! End-to-end coverage for `hector update`'s no-receipt path.
//!
...
fn update_without_receipt_defers_and_exits_one() {
    ...
    // with NoReceipt regardless of how the test host installed hector. This
    ...
    Command::cargo_bin("hector")
        ...
        .stderr(predicates::str::contains("hector-cli-installer.sh"));
}
