...
flowchart LR
    ...
    subgraph IronLint["IronLint"]
        ...
        Core["ironlint-core<br/>load, verify trust, match files"]
...
- **Adapters are thin.** Claude Code, OpenCode, Reasonix, pi, and future adapters capture host edit events and consume IronLint's verdict over a stable ABI. No policy logic lives in the adapter.
